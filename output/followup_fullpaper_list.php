...
$layout = new TLayout("list6","Rounded1Orange1","MobileOrange1");
...
$layout->blocks["top"][] = "recordcontrols";$page_layouts["followup_fullpaper_list"] = $layout;
...
{	
	...
	//determine which field should be used to select values
			$params["lookupSelectField"] = "paperStatus";
										}
