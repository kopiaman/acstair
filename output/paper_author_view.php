...
$layout = new TLayout("view2","Rounded1White_label1","MobileWhite_label1");
...
$layout->blocks["top"][] = "details";$page_layouts["paper_author_view"] = $layout;


$layout = new TLayout("viewtab","Rounded1White_label1","MobileWhite_label1");
...
$layout->blocks["bare"][] = "1";$page_layouts["paper_author_view_Institution_11"] = $layout;
...
$layout->skins["1"] = "fields";
$layout->blocks["bare"][] = "1";$page_layouts["paper_author_view_Institution_21"] = $layout;
...
$xt->assign("editlink_attrs","id=\"editLink".$id."\" name=\"editLink".$id."\" onclick=\"window.location.href='paper_author_edit.php?".$editlink."'\"");
