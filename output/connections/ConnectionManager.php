...
class ConnectionManager
{
	...
	protected function _setConnectionsData()
	{
		...
		$data["dbType"] = 0;
		$data["connId"] = "Tables";
		$data["connName"] = "seminar at localhost";
		$data["connStringType"] = "mysql";
		$data["connectionString"] = "mysql;localhost;root;;;seminar;;1"; //currently unused
		
		$this->_connectionsIdByName["seminar at localhost"] = "Tables";
		...
		$data["connInfo"][2] = "";
		$data["connInfo"][3] = "";
		$data["connInfo"][4] = "seminar";
		$data["connInfo"][5] = ""; //currently unused
		$data["connInfo"][6] = "1"; //currently unused
		$data["ODBCString"] = "DRIVER={MySQL ODBC 3.51 Driver};Server=localhost;Uid=root;Pwd=;Database=seminar;OPTION=3";
	...
	protected function _setTablesConnectionIds()
	{
		...
		$connectionsIds["paper"] = "Tables";
		$connectionsIds["conference"] = "Tables";
		$connectionsIds["set_field"] = "Tables";
		$connectionsIds["set_cat"] = "Tables";
		$connectionsIds["conslider"] = "Tables";
		$connectionsIds["congallery"] = "Tables";
		$connectionsIds["all"] = "Tables";
		$connectionsIds["conpartner"] = "Tables";
		$connectionsIds["quote"] = "Tables";
		$connectionsIds["company"] = "Tables";
		$connectionsIds["participate"] = "Tables";
		$connectionsIds["set_fee"] = "Tables";
		$connectionsIds["confees"] = "Tables";
		$connectionsIds["payments"] = "Tables";
		$connectionsIds["listener"] = "Tables";
		$connectionsIds["certificate"] = "Tables";
		$connectionsIds["slot"] = "Tables";
		$connectionsIds["webslider"] = "Tables";
		$connectionsIds["testmail"] = "Tables";
		$connectionsIds["inviteLetter"] = "Tables";
		$connectionsIds["followup_payment"] = "Tables";
		$connectionsIds["followup_abstract"] = "Tables";
		$connectionsIds["followup_user"] = "Tables";
		$connectionsIds["followup_payment_fullPaper"] = "Tables";
		$connectionsIds["followup_full_paper"] = "Tables";
		$connectionsIds["graph_presenter"] = "Tables";
		$connectionsIds["followup"] = "Tables";
		$connectionsIds["graph_participate"] = "Tables";
		$connectionsIds["graph_user"] = "Tables";
