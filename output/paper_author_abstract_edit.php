...
$layout = new TLayout("edit2","Rounded1Orange1","MobileOrange1");
...
$layout->blocks["top"][] = "details";$page_layouts["paper_author_abstract_edit"] = $layout;
...
$layout->blocks["bare"][] = "1";$page_layouts["paper_author_abstract_edit_Institution_11"] = $layout;
...
$layout->skins["1"] = "fields";
$layout->blocks["bare"][] = "1";$page_layouts["paper_author_abstract_edit_Institution_21"] = $layout;
...
$templatefile = "paper_author_abstract_edit.htm";
...
$skeys = "";
$savedKeys = array();
$keys["paperID"] = urldecode(postvalue("editid1"));
$savedKeys["paperID"] = urldecode(postvalue("editid1"));
...
if ($IsSaved && no_output_done() && $inlineedit == EDIT_SIMPLE)
{
	...
	// key get query
	$keyGetQ = "";
		$keyGetQ.="editid1=".rawurldecode($keys["paperID"])."&";
	// cut last &
	$keyGetQ = substr($keyGetQ, 0, strlen($keyGetQ)-1);	
	// redirect
	header("Location: paper_author_abstract_".$pageObject->getPageType().".php?".$keyGetQ);
...
if($inlineedit != EDIT_INLINE)
{
	...
	if(isEnableSection508())
		$xt->assign_section("author1_label","<label for=\"".GetInputElementId("author1", $id, PAGE_EDIT)."\">","</label>");
	...
	if(isEnableSection508())
		$xt->assign_section("institution1_label","<label for=\"".GetInputElementId("institution1", $id, PAGE_EDIT)."\">","</label>");
	...
	if(isEnableSection508())
		$xt->assign_section("country1_label","<label for=\"".GetInputElementId("country1", $id, PAGE_EDIT)."\">","</label>");
	...
	if(isEnableSection508())
		$xt->assign_section("author2_label","<label for=\"".GetInputElementId("author2", $id, PAGE_EDIT)."\">","</label>");
	...
	if(isEnableSection508())
		$xt->assign_section("institution2_label","<label for=\"".GetInputElementId("institution2", $id, PAGE_EDIT)."\">","</label>");
	...
	if(isEnableSection508())
		$xt->assign_section("address2_label","<label for=\"".GetInputElementId("address2", $id, PAGE_EDIT)."\">","</label>");
	...
	if(isEnableSection508())
		$xt->assign_section("country2_label","<label for=\"".GetInputElementId("country2", $id, PAGE_EDIT)."\">","</label>");
	...
	if(isEnableSection508())
		$xt->assign_section("funded_label","<label for=\"".GetInputElementId("funded", $id, PAGE_EDIT)."\">","</label>");
	...
	if(isEnableSection508())
		$xt->assign_section("abstract_label","<label for=\"".GetInputElementId("abstract", $id, PAGE_EDIT)."\">","</label>");
	...
	if(isEnableSection508())
		$xt->assign_section("fullPaper_label","<label for=\"".GetInputElementId("fullPaper", $id, PAGE_EDIT)."\">","</label>");
...
$xt->assign("viewlink_attrs","id=\"viewButton".$id."\" name=\"viewButton".$id."\" onclick=\"window.location.href='paper_author_abstract_view.php?".$viewlink."'\"");
