...
function checkTableName($shortTName, $type=false)
{
	...
	if ("user" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("paper" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("conference" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("set_field" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("set_cat" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("conslider" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("congallery" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("all" == $shortTName && ($type===false || ($type!==false && $type == 1)))
		return true;
	if ("conpartner" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("quote" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("company" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("participate" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("set_fee" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("confees" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("payments" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("listener" == $shortTName && ($type===false || ($type!==false && $type == 1)))
		return true;
	if ("certificate" == $shortTName && ($type===false || ($type!==false && $type == 1)))
		return true;
	if ("slot" == $shortTName && ($type===false || ($type!==false && $type == 1)))
		return true;
	if ("webslider" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("testmail" == $shortTName && ($type===false || ($type!==false && $type == 1)))
		return true;
	if ("inviteLetter" == $shortTName && ($type===false || ($type!==false && $type == 1)))
		return true;
	if ("followup_payment" == $shortTName && ($type===false || ($type!==false && $type == 1)))
		return true;
	if ("followup_abstract" == $shortTName && ($type===false || ($type!==false && $type == 1)))
		return true;
	if ("followup_user" == $shortTName && ($type===false || ($type!==false && $type == 1)))
		return true;
	if ("followup_payment_fullPaper" == $shortTName && ($type===false || ($type!==false && $type == 1)))
		return true;
	if ("followup_full_paper" == $shortTName && ($type===false || ($type!==false && $type == 1)))
		return true;
	if ("graph_presenter" == $shortTName && ($type===false || ($type!==false && $type == 3)))
		return true;
	if ("followup" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("graph_participate" == $shortTName && ($type===false || ($type!==false && $type == 3)))
		return true;
	if ("graph_user" == $shortTName && ($type===false || ($type!==false && $type == 3)))
		return true;
	return false;
}
...
function GetTablesList($pdfMode = false)
{
	$arr = array();
		...
		$arr[]="testmail";
		$arr[]="inviteLetter";
		$arr[]="followup_payment";
		$arr[]="followup_abstract";
		$arr[]="followup_user";
		$arr[]="followup_payment_fullPaper";
		$arr[]="followup_full_paper";
		$arr[]="graph_presenter";
		$arr[]="followup";
		$arr[]="graph_participate";
		$arr[]="graph_user";
	return $arr;
}
...
{
	if($shorttable=="graph_presenter")
		return "2DPie";
	if($shorttable=="graph_participate")
		return "2DPie";
	if($shorttable=="graph_user")
		return "2DPie";
	return "";
}
...
function GetUserPermissionsStatic( $table )
{
	...
	if($table=="user" && $sUserGroup=="author")
	{
			return "".$extraPerm;
	}
	if($table=="user" && $sUserGroup=="admin")
	{
...
//	default permissions	
	...
	if($table=="paper" && $sUserGroup=="author")
	{
			return "".$extraPerm;
	}
	if($table=="paper" && $sUserGroup=="admin")
	{
			return "AEDSPI".$extraPerm;
	}
//	default permissions	
	...
	if($table=="conference" && $sUserGroup=="author")
	{
			return "".$extraPerm;
	}
	if($table=="conference" && $sUserGroup=="admin")
	{
			return "AEDSPI".$extraPerm;
	}
//	default permissions	
	...
	if($table=="set_field" && $sUserGroup=="author")
	{
			return "".$extraPerm;
	}
	if($table=="set_field" && $sUserGroup=="admin")
	{
			return "AEDSPI".$extraPerm;
	}
//	default permissions	
	...
	if($table=="set_cat" && $sUserGroup=="author")
	{
			return "".$extraPerm;
	}
	if($table=="set_cat" && $sUserGroup=="admin")
	{
			return "AEDSPI".$extraPerm;
	}
//	default permissions	
	...
	if($table=="conslider" && $sUserGroup=="author")
	{
			return "".$extraPerm;
	}
	if($table=="conslider" && $sUserGroup=="admin")
	{
			return "AEDSPI".$extraPerm;
	}
//	default permissions	
	...
	if($table=="congallery" && $sUserGroup=="author")
	{
			return "".$extraPerm;
	}
	if($table=="congallery" && $sUserGroup=="admin")
	{
			return "AEDSPI".$extraPerm;
	}
//	default permissions	
	...
	if($table=="all" && $sUserGroup=="author")
	{
			return "".$extraPerm;
	}
	if($table=="all" && $sUserGroup=="admin")
	{
			return "AEDSPI".$extraPerm;
	}
//	default permissions	
	...
	if($table=="conpartner" && $sUserGroup=="author")
	{
			return "".$extraPerm;
	}
	if($table=="conpartner" && $sUserGroup=="admin")
	{
			return "AEDSPI".$extraPerm;
	}
//	default permissions	
	...
	if($table=="quote" && $sUserGroup=="author")
	{
			return "".$extraPerm;
	}
	if($table=="quote" && $sUserGroup=="admin")
	{
			return "AEDSPI".$extraPerm;
	}
//	default permissions	
	...
	if($table=="company" && $sUserGroup=="author")
	{
			return "".$extraPerm;
	}
	if($table=="company" && $sUserGroup=="admin")
	{
			return "AEDSPI".$extraPerm;
	}
//	default permissions	
	...
	if($table=="participate" && $sUserGroup=="author")
	{
			return "".$extraPerm;
	}
	if($table=="participate" && $sUserGroup=="admin")
	{
			return "AEDSPI".$extraPerm;
	}
//	default permissions	
	if($table=="participate")
	{
		return "".$extraPerm;
	}
	if($table=="set_fee" && $sUserGroup=="author")
	{
			return "".$extraPerm;
	}
	if($table=="set_fee" && $sUserGroup=="admin")
	{
			return "AEDSPI".$extraPerm;
	}
//	default permissions	
	...
	if($table=="confees" && $sUserGroup=="author")
	{
			return "".$extraPerm;
	}
	if($table=="confees" && $sUserGroup=="admin")
	{
			return "AEDSPI".$extraPerm;
	}
//	default permissions	
	...
	if($table=="payments" && $sUserGroup=="author")
	{
			return "".$extraPerm;
	}
	if($table=="payments" && $sUserGroup=="admin")
	{
			return "AEDSPI".$extraPerm;
	}
//	default permissions	
	...
	if($table=="listener" && $sUserGroup=="author")
	{
			return "".$extraPerm;
	}
	if($table=="listener" && $sUserGroup=="admin")
	{
			return "".$extraPerm;
	}
//	default permissions	
	...
	if($table=="certificate" && $sUserGroup=="author")
	{
			return "".$extraPerm;
	}
	if($table=="certificate" && $sUserGroup=="admin")
	{
			return "".$extraPerm;
	}
//	default permissions	
	...
	if($table=="slot" && $sUserGroup=="author")
	{
			return "".$extraPerm;
	}
	if($table=="slot" && $sUserGroup=="admin")
	{
			return "".$extraPerm;
	}
//	default permissions	
	...
	if($table=="webslider" && $sUserGroup=="author")
	{
			return "".$extraPerm;
	}
	if($table=="webslider" && $sUserGroup=="admin")
	{
			return "".$extraPerm;
	}
//	default permissions	
	...
	if($table=="testmail" && $sUserGroup=="author")
	{
			return "".$extraPerm;
	}
	if($table=="testmail" && $sUserGroup=="admin")
	{
			return "".$extraPerm;
	}
//	default permissions	
	...
	if($table=="inviteLetter" && $sUserGroup=="author")
	{
			return "".$extraPerm;
	}
	if($table=="inviteLetter" && $sUserGroup=="admin")
	{
			return "".$extraPerm;
	}
//	default permissions	
	if($table=="inviteLetter")
	{
		return "".$extraPerm;
	}
	if($table=="followup_payment" && $sUserGroup=="author")
	{
			return "".$extraPerm;
	}
	if($table=="followup_payment" && $sUserGroup=="admin")
	{
			return "".$extraPerm;
	}
//	default permissions	
	if($table=="followup_payment")
	{
		return "".$extraPerm;
	}
	if($table=="followup_abstract" && $sUserGroup=="author")
	{
			return "".$extraPerm;
	}
	if($table=="followup_abstract" && $sUserGroup=="admin")
	{
			return "".$extraPerm;
	}
//	default permissions	
	if($table=="followup_abstract")
	{
		return "".$extraPerm;
	}
	if($table=="followup_user" && $sUserGroup=="author")
	{
			return "".$extraPerm;
	}
	if($table=="followup_user" && $sUserGroup=="admin")
	{
			return "".$extraPerm;
	}
//	default permissions	
	if($table=="followup_user")
	{
		return "".$extraPerm;
	}
	if($table=="followup_payment_fullPaper" && $sUserGroup=="author")
	{
			return "".$extraPerm;
	}
	if($table=="followup_payment_fullPaper" && $sUserGroup=="admin")
	{
			return "".$extraPerm;
	}
//	default permissions	
	if($table=="followup_payment_fullPaper")
	{
		return "".$extraPerm;
	}
	if($table=="followup_full_paper" && $sUserGroup=="author")
	{
			return "".$extraPerm;
	}
	if($table=="followup_full_paper" && $sUserGroup=="admin")
	{
			return "".$extraPerm;
	}
//	default permissions	
	if($table=="followup_full_paper")
	{
		return "".$extraPerm;
	}
	if($table=="graph_presenter" && $sUserGroup=="author")
	{
			return "".$extraPerm;
	}
	if($table=="graph_presenter" && $sUserGroup=="admin")
	{
			return "".$extraPerm;
	}
//	default permissions	
	if($table=="graph_presenter")
	{
		return "".$extraPerm;
	}
	if($table=="followup" && $sUserGroup=="author")
	{
			return "".$extraPerm;
	}
	if($table=="followup" && $sUserGroup=="admin")
	{
			return "".$extraPerm;
	}
//	default permissions	
	...
	if($table=="graph_participate" && $sUserGroup=="author")
	{
			return "".$extraPerm;
	}
	if($table=="graph_participate" && $sUserGroup=="admin")
	{
			return "".$extraPerm;
	}
//	default permissions	
	if($table=="graph_participate")
	{
		return "".$extraPerm;
	}
	if($table=="graph_user" && $sUserGroup=="author")
	{
			return "".$extraPerm;
	}
	if($table=="graph_user" && $sUserGroup=="admin")
	{
			return "".$extraPerm;
	}
//	default permissions	
...
function SetAuthSessionData($pUsername, &$data, $fromFacebook, $password, &$pageObject = null)
{
	...
	$_SESSION["_paper_OwnerID"] = $data["userID"];
		$_SESSION["_slot_OwnerID"] = $data["userID"];
		$_SESSION["_inviteLetter_OwnerID"] = $data["userID"];
		$_SESSION["_followup_payment_OwnerID"] = $data["userID"];
		$_SESSION["_followup_payment_fullPaper_OwnerID"] = $data["userID"];
		$_SESSION["_followup_full_paper_OwnerID"] = $data["userID"];
