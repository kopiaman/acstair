...
class tDAL
{
	var $tblTables__company;
	var $tblTables__confees;
	var $tblTables__conference;
	var $tblTables__congallery;
	var $tblTables__conpartner;
	var $tblTables__conslider;
	var $tblTables__followup;
	var $tblTables__paper;
	var $tblTables__participate;
	var $tblTables__payments;
	var $tblTables__quote;
	var $tblTables__set_cat;
	var $tblTables__set_fee;
	var $tblTables__set_field;
	var $tblTables__user;
	var $tblTables__webslider;
	var $lstTables;
	var $Table = array();
	...
	function FillTablesList()
	{
		if($this->lstTables)
			return;
		$this->lstTables[] = array("name" => "company", "varname" => "Tables__company", "altvarname" => "company", "connId" => "Tables", "schema" => "", "connName" => "seminar at localhost");
		$this->lstTables[] = array("name" => "confees", "varname" => "Tables__confees", "altvarname" => "confees", "connId" => "Tables", "schema" => "", "connName" => "seminar at localhost");
		$this->lstTables[] = array("name" => "conference", "varname" => "Tables__conference", "altvarname" => "conference", "connId" => "Tables", "schema" => "", "connName" => "seminar at localhost");
		$this->lstTables[] = array("name" => "congallery", "varname" => "Tables__congallery", "altvarname" => "congallery", "connId" => "Tables", "schema" => "", "connName" => "seminar at localhost");
		$this->lstTables[] = array("name" => "conpartner", "varname" => "Tables__conpartner", "altvarname" => "conpartner", "connId" => "Tables", "schema" => "", "connName" => "seminar at localhost");
		$this->lstTables[] = array("name" => "conslider", "varname" => "Tables__conslider", "altvarname" => "conslider", "connId" => "Tables", "schema" => "", "connName" => "seminar at localhost");
		$this->lstTables[] = array("name" => "followup", "varname" => "Tables__followup", "altvarname" => "followup", "connId" => "Tables", "schema" => "", "connName" => "seminar at localhost");
		$this->lstTables[] = array("name" => "paper", "varname" => "Tables__paper", "altvarname" => "paper", "connId" => "Tables", "schema" => "", "connName" => "seminar at localhost");
		$this->lstTables[] = array("name" => "participate", "varname" => "Tables__participate", "altvarname" => "participate", "connId" => "Tables", "schema" => "", "connName" => "seminar at localhost");
		$this->lstTables[] = array("name" => "payments", "varname" => "Tables__payments", "altvarname" => "payments", "connId" => "Tables", "schema" => "", "connName" => "seminar at localhost");
		$this->lstTables[] = array("name" => "quote", "varname" => "Tables__quote", "altvarname" => "quote", "connId" => "Tables", "schema" => "", "connName" => "seminar at localhost");
		$this->lstTables[] = array("name" => "set_cat", "varname" => "Tables__set_cat", "altvarname" => "set_cat", "connId" => "Tables", "schema" => "", "connName" => "seminar at localhost");
		$this->lstTables[] = array("name" => "set_fee", "varname" => "Tables__set_fee", "altvarname" => "set_fee", "connId" => "Tables", "schema" => "", "connName" => "seminar at localhost");
		$this->lstTables[] = array("name" => "set_field", "varname" => "Tables__set_field", "altvarname" => "set_field", "connId" => "Tables", "schema" => "", "connName" => "seminar at localhost");
		$this->lstTables[] = array("name" => "user", "varname" => "Tables__user", "altvarname" => "user", "connId" => "Tables", "schema" => "", "connName" => "seminar at localhost");
		$this->lstTables[] = array("name" => "webslider", "varname" => "Tables__webslider", "altvarname" => "webslider", "connId" => "Tables", "schema" => "", "connName" => "seminar at localhost");
	}
