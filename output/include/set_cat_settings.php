...
{
	$fieldLabelsset_cat["English"] = array();
	$fieldToolTipsset_cat["English"] = array();
	$pageTitlesset_cat["English"] = array();
	$fieldLabelsset_cat["English"]["catID"] = "Cat ID";
	$fieldToolTipsset_cat["English"]["catID"] = "";
	$fieldLabelsset_cat["English"]["nameCat"] = "Name";
	$fieldToolTipsset_cat["English"]["nameCat"] = "";
	if (count($fieldToolTipsset_cat["English"]))
...
$tdataset_cat[".showSearchPanel"] = true;
		$tdataset_cat[".flexibleSearch"] = true;
...
$tdataset_cat[".detailsLinksOnList"] = "1";

$tdataset_cat[".allSearchFields"] = array();
$tdataset_cat[".filterFields"] = array();
$tdataset_cat[".requiredSearchFields"] = array();

$tdataset_cat[".allSearchFields"][] = "nameCat";
	

$tdataset_cat[".googleLikeFields"] = array();
$tdataset_cat[".googleLikeFields"][] = "catID";
$tdataset_cat[".googleLikeFields"][] = "nameCat";


$tdataset_cat[".advSearchFields"] = array();
$tdataset_cat[".advSearchFields"][] = "nameCat";
...
$tdataset_cat[".sqlHead"] = "SELECT catID,  	nameCat";
...
$tdataset_cat[".listFields"][] = "nameCat";
...
$tdataset_cat[".masterListFields"][] = "nameCat";

$tdataset_cat[".inlineAddFields"] = array();
$tdataset_cat[".inlineAddFields"][] = "nameCat";

$tdataset_cat[".editFields"] = array();

$tdataset_cat[".inlineEditFields"] = array();
$tdataset_cat[".inlineEditFields"][] = "nameCat";

$tdataset_cat[".exportFields"] = array();

$tdataset_cat[".importFields"] = array();
$tdataset_cat[".importFields"][] = "catID";
$tdataset_cat[".importFields"][] = "nameCat";
...
//	Custom field settings
	$fdata = array();
	$fdata["Index"] = 2;
	$fdata["strName"] = "nameCat";
	$fdata["GoodName"] = "nameCat";
	$fdata["ownerTable"] = "set_cat";
	$fdata["Label"] = GetFieldLabel("set_cat","nameCat");
	$fdata["FieldType"] = 200;
		...
		$fdata["strField"] = "nameCat";

		$fdata["isSQLExpression"] = true;
	$fdata["FullName"] = "nameCat";
...
$proto0["m_strFieldList"] = "catID,  	nameCat";
...
$tableEvents["set_cat"] = new eventsBase;
$tdataset_cat[".hasEvents"] = false;
