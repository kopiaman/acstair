...
class XTempl
{
	...
	function XTempl( $hideAddedCharts = false )
	{
		...
		{
			$this->assign_function("graph_presenter_chart","xt_showchart",array("chartname"=>"graph_presenter","table"=>"graph_presenter","ctype"=>"2DPie"));
			$this->assign_function("graph_participate_chart","xt_showchart",array("chartname"=>"graph_participate","table"=>"graph_participate","ctype"=>"2DPie"));
			$this->assign_function("graph_user_chart","xt_showchart",array("chartname"=>"graph_user","table"=>"graph_user","ctype"=>"2DPie"));
		}
