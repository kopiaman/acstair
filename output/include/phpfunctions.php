...
function CustomExpression($value, $data, $field, $ptype, $table="")
{
	...
	if(!$table)
		$table = $strTableName;
				if($table=="paper" && $field=="abstract")
	{
		$file=$data['abstract'];
if($file){
$value="<span><a href='../webcon/abstract/$file' target='_new'>AB</a></span>";
};;
		return $value;
	}
				if($table=="paper" && $field=="fullPaper")
	{
		$file=$data['fullPaper'];
if($file){
$value="<span><a href='../webcon/fullpaper/$file' target='_new'> FP </a></span>";
};;
		return $value;
	}
				if($table=="paper" && $field=="paymentStatus")
	{
		$status=$data['paymentStatus'];
if($status=="Pending"){
$value ="<font color ='red'>Pending</font>";
}else if ($status='Paid'){
$value ="<font color ='green'><strong>Paid</strong></font>";}
else{
$value=$value;
};;
		return $value;
	}
				if($table=="conference" && $field=="opt")
	{
		$value="";;
		return $value;
	}
				if($table=="payments" && $field=="opt")
	{
		
$receiptID=$data['id'];
$value="<span><a href='x_receipt.php?receiptID=$receiptID' target='_blank'> PRINT </a></span>";
		return $value;
	}
				if($table=="certificate" && $field=="opt")
	{
		$value="";;
		return $value;
	}
				if($table=="slot" && $field=="opt")
	{
		$value="";;
		return $value;
	}
				if($table=="testmail" && $field=="opt")
	{
		$value="";;
		return $value;
	}
				if($table=="inviteLetter" && $field=="abstract")
	{
		$file=$data['abstract'];
if($file){
$value="<span><a href='../webcon/abstract/$file' target='_new'>AB</a></span>";
		...
		return $value;
				...
				if($table=="inviteLetter" && $field=="fullPaper")
	{
		$file=$data['fullPaper'];
if($file){
$value="<span><a href='../webcon/fullpaper/$file' target='_new'> FP </a></span>";
		...
		return $value;
				...
				if($table=="inviteLetter" && $field=="print")
	{
		
$paperID=$data['paperID'];
$value="<span><a href='x_inviteLetter.php?paperID=$paperID' target='_blank'> VIEW </a></span>";
		return $value;
	}
				if($table=="followup_payment" && $field=="abstract")
	{
		$file=$data['abstract'];
if($file){
$value="<span><a href='../webcon/abstract/$file' target='_new'>AB</a></span>";
		...
		return $value;
				...
				if($table=="followup_payment" && $field=="fullPaper")
	{
		$file=$data['fullPaper'];
if($file){
$value="<span><a href='../webcon/fullpaper/$file' target='_new'> FP </a></span>";
		...
		return $value;
				...
				if($table=="followup_payment" && $field=="followup")
	{
		$value="";;
		return $value;
	}
				if($table=="followup_payment_fullPaper" && $field=="abstract")
	{
		$file=$data['abstract'];
if($file){
$value="<span><a href='../webcon/abstract/$file' target='_new'>AB</a></span>";
		...
		return $value;
				...
				if($table=="followup_payment_fullPaper" && $field=="fullPaper")
	{
		$file=$data['fullPaper'];
if($file){
$value="<span><a href='../webcon/fullpaper/$file' target='_new'> FP </a></span>";
		...
		return $value;
				...
				if($table=="followup_full_paper" && $field=="abstract")
	{
		$file=$data['abstract'];
if($file){
$value="<span><a href='../webcon/abstract/$file' target='_new'>AB</a></span>";
		...
		return $value;
				...
				if($table=="followup_full_paper" && $field=="fullPaper")
	{
		$file=$data['fullPaper'];
if($file){
$value="<span><a href='../webcon/fullpaper/$file' target='_new'> FP </a></span>";
...
function fileCustomExpression($file, $data, $field, $ptype, $table="")
{
	...
	if(!$table)
		$table = $strTableName;
				if($table=="paper" && $field=="PPT")
	{
		$value ='PPT';;
		return $value;
	}
				if($table=="conference" && $field=="venuePhoto")
	{
		;
		return $value;
	}
				if($table=="conslider" && $field=="photo")
	{
		;
		return $value;
	}
				if($table=="congallery" && $field=="photo")
	{
		;
		return $value;
	}
				if($table=="conpartner" && $field=="photo")
	{
		;
		return $value;
	}
				if($table=="webslider" && $field=="photo")
	{
		;
		return $value;
	}
...
function GetLWWhere($field, $ptype, $table = "")
{
	...
	if(!$table)
		$table = $strTableName;
				if($table=="user" && $field=="note")
	{
		return "catID=12";
	}
				if($table=="paper" && $field=="paperStatus")
	{
		return "catID=8";
	}
				if($table=="paper" && $field=="paymentStatus")
	{
		return "catID=9";
				...
				if($table=="conference" && $field=="cstatus")
	{
		return "catID=1";
	}
				if($table=="congallery" && $field=="cat")
	{
		return "catID=4";
	}
				if($table=="payments" && $field=="currency")
	{
		return "catID=2";
	}
				if($table=="slot" && $field=="paperStatus")
	{
		return "catID=8";
	}
				if($table=="slot" && $field=="paymentStatus")
	{
		return "catID=9";
	}
				if($table=="slot" && $field=="slotTime")
	{
		return "catID=11";
	}
				if($table=="testmail" && $field=="currency")
	{
		return "catID=2";
	}
				if($table=="inviteLetter" && $field=="paperStatus")
	{
		return "catID=8";
	}
				if($table=="inviteLetter" && $field=="paymentStatus")
	{
		return "catID=9";
	}
				if($table=="followup_payment" && $field=="paperStatus")
	{
		return "catID=8";
	}
				if($table=="followup_payment" && $field=="paymentStatus")
	{
		return "catID=9";
	}
				if($table=="followup_payment" && $field=="note")
	{
		return "catID=12";
	}
				if($table=="followup_abstract" && $field=="note")
	{
		return "catID=12";
	}
				if($table=="followup_user" && $field=="note")
	{
		return "catID=12";
	}
				if($table=="followup_payment_fullPaper" && $field=="paperStatus")
	{
		return "catID=8";
	}
				if($table=="followup_payment_fullPaper" && $field=="paymentStatus")
	{
		return "catID=9";
	}
				if($table=="followup_payment_fullPaper" && $field=="note")
	{
		return "catID=12";
	}
				if($table=="followup_full_paper" && $field=="paperStatus")
	{
		return "catID=8";
	}
				if($table=="followup_full_paper" && $field=="paymentStatus")
	{
		return "catID=9";
	}
				if($table=="followup_full_paper" && $field=="note")
	{
		return "catID=12";
	}
	return "";
...
function GetDefaultValue($field, $ptype, $table="")
{
				...
				if($table=="paper" && $field=="paperStatus")
	{
		return "New";
				...
				if($table=="payments" && $field=="payStatus")
	{
		return "Completed";
	}
				if($table=="payments" && $field=="payDate")
	{
		return Now();
	}
				if($table=="slot" && $field=="paperStatus")
	{
		return "New";
				...
				if($table=="testmail" && $field=="payStatus")
	{
		return "Completed";
	}
				if($table=="testmail" && $field=="payDate")
	{
		return Now();
	}
				if($table=="inviteLetter" && $field=="paperStatus")
