...
require_once("include/followup_payment_variables.php");
...
$page_layouts["followup_payment_view"] = $layout;
...
$layout = new TLayout("viewtab", "CoralCoral", "MobileCoral");
$layout->version = 2;
...
$page_layouts["followup_payment_view_Institution_11"] = $layout;
...
$layout->blocks["bare"][] = "1";
$page_layouts["followup_payment_view_Institution_21"] = $layout;
...
$keys = array();
$keys["paperID"] = postvalue("editid1");
