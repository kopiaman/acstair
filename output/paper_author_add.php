...
$layout = new TLayout("add2","Rounded1White_label1","MobileWhite_label1");
...
$layout->blocks["top"][] = "details";$page_layouts["paper_author_add"] = $layout;
...
$layout->blocks["bare"][] = "1";$page_layouts["paper_author_add_Institution_11"] = $layout;
...
$layout->skins["1"] = "fields";
$layout->blocks["bare"][] = "1";$page_layouts["paper_author_add_Institution_21"] = $layout;
...
if($inlineadd == ADD_INLINE)
	$templatefile = "paper_author_inline_add.htm";
else
	$templatefile = "paper_author_add.htm";
...
if(isset($_REQUEST['afteradd'])){
		header('Location: paper_author_add.php');
			...
			if($inlineadd==ADD_SIMPLE || $inlineadd==ADD_MASTER)
			{
				...
				if (count($keys))
				{
					...
					if($pageObject->pSet->hasEditPage() && $permis['edit'])
						$message .='&nbsp;<a href=\'paper_author_edit.php?'.$keylink.'\'>'."Edit".'</a>&nbsp;';
					if($pageObject->pSet->hasViewPage() && $permis['search'])
						$message .='&nbsp;<a href=\'paper_author_view.php?'.$keylink.'\'>'."View".'</a>&nbsp;';
				}
				$mesClass = "mes_ok";	
			}
		}
...
if (no_output_done() && $inlineadd==ADD_SIMPLE && $IsSaved)
{
	...
	// redirect
	header("Location: paper_author_".$pageObject->getPageType().".php");
