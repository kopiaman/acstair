...
$layout = new TLayout("add2","Purific1Orange1","MobileOrange1");
...
if(@$_POST["a"]=="added")
{
	...
	$avalues=array();
	$blobfields=array();
//	processing creg - start
	$inlineAddOption = true;
	$inlineAddOption = $inlineadd!=ADD_INLINE;
	if($inlineAddOption)
	{
		$control_creg = $pageObject->getControl("creg", $id);
		$control_creg->readWebValue($avalues, $blobfields, "", false, $afilename_values);
	}
//	processing creg - end
//	processing cname - start
	$inlineAddOption = true;
	$inlineAddOption = $inlineadd!=ADD_INLINE;
	if($inlineAddOption)
	{
		$control_cname = $pageObject->getControl("cname", $id);
		$control_cname->readWebValue($avalues, $blobfields, "", false, $afilename_values);
	}
//	processing cname - end
//	processing caddress - start
	$inlineAddOption = true;
	$inlineAddOption = $inlineadd!=ADD_INLINE;
	if($inlineAddOption)
	{
		$control_caddress = $pageObject->getControl("caddress", $id);
		$control_caddress->readWebValue($avalues, $blobfields, "", false, $afilename_values);
	}
//	processing caddress - end
//	processing ccity - start
	$inlineAddOption = true;
	$inlineAddOption = $inlineadd!=ADD_INLINE;
	if($inlineAddOption)
	{
		$control_ccity = $pageObject->getControl("ccity", $id);
		$control_ccity->readWebValue($avalues, $blobfields, "", false, $afilename_values);
	}
//	processing ccity - end
//	processing cstate - start
	$inlineAddOption = true;
	$inlineAddOption = $inlineadd!=ADD_INLINE;
	if($inlineAddOption)
	{
		$control_cstate = $pageObject->getControl("cstate", $id);
		$control_cstate->readWebValue($avalues, $blobfields, "", false, $afilename_values);
	}
//	processing cstate - end
//	processing ccountry - start
	$inlineAddOption = true;
	$inlineAddOption = $inlineadd!=ADD_INLINE;
	if($inlineAddOption)
	{
		$control_ccountry = $pageObject->getControl("ccountry", $id);
		$control_ccountry->readWebValue($avalues, $blobfields, "", false, $afilename_values);
	}
//	processing ccountry - end
//	processing ctel - start
	$inlineAddOption = true;
	$inlineAddOption = $inlineadd!=ADD_INLINE;
	if($inlineAddOption)
	{
		$control_ctel = $pageObject->getControl("ctel", $id);
		$control_ctel->readWebValue($avalues, $blobfields, "", false, $afilename_values);
	}
//	processing ctel - end
//	processing cfax - start
	$inlineAddOption = true;
	$inlineAddOption = $inlineadd!=ADD_INLINE;
	if($inlineAddOption)
	{
		$control_cfax = $pageObject->getControl("cfax", $id);
		$control_cfax->readWebValue($avalues, $blobfields, "", false, $afilename_values);
	}
//	processing cfax - end
//	processing cemail - start
	$inlineAddOption = true;
	$inlineAddOption = $inlineadd!=ADD_INLINE;
	if($inlineAddOption)
	{
		$control_cemail = $pageObject->getControl("cemail", $id);
		$control_cemail->readWebValue($avalues, $blobfields, "", false, $afilename_values);
	}
//	processing cemail - end
...
//	processing creg - start
			...
			if($inlineAddOption)
			{
				$control_creg->afterSuccessfulSave();
			}
//	processing creg - end
//	processing cname - start
			$inlineAddOption = true;
...
//	processing caddress - start
			...
			if($inlineAddOption)
			{
				$control_caddress->afterSuccessfulSave();
			}
//	processing caddress - end
//	processing ccity - start
			$inlineAddOption = true;
			...
			if($inlineAddOption)
			{
				$control_ccity->afterSuccessfulSave();
			}
//	processing ccity - end
//	processing cstate - start
			$inlineAddOption = true;
			...
			if($inlineAddOption)
			{
				$control_cstate->afterSuccessfulSave();
			}
//	processing cstate - end
//	processing ccountry - start
			$inlineAddOption = true;
			...
			if($inlineAddOption)
			{
				$control_ccountry->afterSuccessfulSave();
			}
//	processing ccountry - end
//	processing ctel - start
			$inlineAddOption = true;
			...
			if($inlineAddOption)
			{
				$control_ctel->afterSuccessfulSave();
			}
//	processing ctel - end
//	processing cfax - start
			$inlineAddOption = true;
			...
			if($inlineAddOption)
			{
				$control_cfax->afterSuccessfulSave();
			}
//	processing cfax - end
//	processing cemail - start
			$inlineAddOption = true;
			...
			if($inlineAddOption)
			{
				$control_cemail->afterSuccessfulSave();
			}
//	processing cemail - end
...
if(array_key_exists("copyid1",$_REQUEST) || array_key_exists("editid1",$_REQUEST))
{
	...
	{
		$copykeys["coid"]=postvalue("copyid1");
	}
	else
	{
		$copykeys["coid"]=postvalue("editid1");
	}
...
if($readavalues)
{
	$defvalues["cname"]=@$avalues["cname"];
	$defvalues["creg"]=@$avalues["creg"];
	$defvalues["caddress"]=@$avalues["caddress"];
	$defvalues["ccity"]=@$avalues["ccity"];
	$defvalues["cstate"]=@$avalues["cstate"];
	$defvalues["ccountry"]=@$avalues["ccountry"];
	$defvalues["ctel"]=@$avalues["ctel"];
	$defvalues["cfax"]=@$avalues["cfax"];
	$defvalues["cemail"]=@$avalues["cemail"];
}
...
if($inlineadd!=ADD_INLINE)
{
	...
	if(!$pageObject->isAppearOnTabs("cname"))
		$xt->assign("cname_fieldblock",true);
	else
		$xt->assign("cname_tabfieldblock",true);
	$xt->assign("cname_label",true);
	if(isEnableSection508())
		$xt->assign_section("cname_label","<label for=\"".GetInputElementId("cname", $id, PAGE_ADD)."\">","</label>");
	
	if(!$pageObject->isAppearOnTabs("creg"))
		$xt->assign("creg_fieldblock",true);
	else
		$xt->assign("creg_tabfieldblock",true);
	$xt->assign("creg_label",true);
	if(isEnableSection508())
		$xt->assign_section("creg_label","<label for=\"".GetInputElementId("creg", $id, PAGE_ADD)."\">","</label>");
	
	if(!$pageObject->isAppearOnTabs("caddress"))
		$xt->assign("caddress_fieldblock",true);
	else
		$xt->assign("caddress_tabfieldblock",true);
	$xt->assign("caddress_label",true);
	if(isEnableSection508())
		$xt->assign_section("caddress_label","<label for=\"".GetInputElementId("caddress", $id, PAGE_ADD)."\">","</label>");
	
	if(!$pageObject->isAppearOnTabs("ccity"))
		$xt->assign("ccity_fieldblock",true);
	else
		$xt->assign("ccity_tabfieldblock",true);
	$xt->assign("ccity_label",true);
	if(isEnableSection508())
		$xt->assign_section("ccity_label","<label for=\"".GetInputElementId("ccity", $id, PAGE_ADD)."\">","</label>");
	
	if(!$pageObject->isAppearOnTabs("cstate"))
		$xt->assign("cstate_fieldblock",true);
	else
		$xt->assign("cstate_tabfieldblock",true);
	$xt->assign("cstate_label",true);
	if(isEnableSection508())
		$xt->assign_section("cstate_label","<label for=\"".GetInputElementId("cstate", $id, PAGE_ADD)."\">","</label>");
	
	if(!$pageObject->isAppearOnTabs("ccountry"))
		$xt->assign("ccountry_fieldblock",true);
	else
		$xt->assign("ccountry_tabfieldblock",true);
	$xt->assign("ccountry_label",true);
	if(isEnableSection508())
		$xt->assign_section("ccountry_label","<label for=\"".GetInputElementId("ccountry", $id, PAGE_ADD)."\">","</label>");
	
	if(!$pageObject->isAppearOnTabs("ctel"))
		$xt->assign("ctel_fieldblock",true);
	else
		$xt->assign("ctel_tabfieldblock",true);
	$xt->assign("ctel_label",true);
	if(isEnableSection508())
		$xt->assign_section("ctel_label","<label for=\"".GetInputElementId("ctel", $id, PAGE_ADD)."\">","</label>");
	
	if(!$pageObject->isAppearOnTabs("cfax"))
		$xt->assign("cfax_fieldblock",true);
	else
		$xt->assign("cfax_tabfieldblock",true);
	$xt->assign("cfax_label",true);
	if(isEnableSection508())
		$xt->assign_section("cfax_label","<label for=\"".GetInputElementId("cfax", $id, PAGE_ADD)."\">","</label>");
	
	if(!$pageObject->isAppearOnTabs("cemail"))
		$xt->assign("cemail_fieldblock",true);
	else
		$xt->assign("cemail_tabfieldblock",true);
	$xt->assign("cemail_label",true);
	if(isEnableSection508())
		$xt->assign_section("cemail_label","<label for=\"".GetInputElementId("cemail", $id, PAGE_ADD)."\">","</label>");
...
if(@$_POST["a"]=="added" && ($inlineadd == ADD_INLINE || $inlineadd == ADD_MASTER || $inlineadd==ADD_POPUP)) 
{
	...
	$keylink="";
	$keylink.="&key1=".htmlspecialchars(rawurlencode(@$data["coid"]));
...
//	creg
	...
	if($display)
	{	
		$value = $pageObject->showDBValue("creg", $data, $keylink);
		$showValues["creg"] = $value;
		$showFields[] = "creg";
	}	
//	caddress
	$display = false;
	...
	if($display)
	{	
		$value = $pageObject->showDBValue("caddress", $data, $keylink);
		$showValues["caddress"] = $value;
		$showFields[] = "caddress";
	}	
//	ccity
	$display = false;
	...
	if($display)
	{	
		$value = $pageObject->showDBValue("ccity", $data, $keylink);
		$showValues["ccity"] = $value;
		$showFields[] = "ccity";
	}	
//	cstate
	$display = false;
	...
	if($display)
	{	
		$value = $pageObject->showDBValue("cstate", $data, $keylink);
		$showValues["cstate"] = $value;
		$showFields[] = "cstate";
	}	
//	ccountry
	$display = false;
	...
	if($display)
	{	
		$value = $pageObject->showDBValue("ccountry", $data, $keylink);
		$showValues["ccountry"] = $value;
		$showFields[] = "ccountry";
	}	
//	ctel
	$display = false;
	...
	if($display)
	{	
		$value = $pageObject->showDBValue("ctel", $data, $keylink);
		$showValues["ctel"] = $value;
		$showFields[] = "ctel";
	}	
//	cfax
	$display = false;
	...
	if($display)
	{	
		$value = $pageObject->showDBValue("cfax", $data, $keylink);
		$showValues["cfax"] = $value;
		$showFields[] = "cfax";
	}	
//	cemail
	$display = false;
	...
	if($display)
	{	
		$value = $pageObject->showDBValue("cemail", $data, $keylink);
		$showValues["cemail"] = $value;
		$showFields[] = "cemail";
	}	
		$showRawValues["coid"] = substr($data["coid"],0,100);
		$showRawValues["cname"] = substr($data["cname"],0,100);
		$showRawValues["creg"] = substr($data["creg"],0,100);
		$showRawValues["caddress"] = substr($data["caddress"],0,100);
		$showRawValues["ccity"] = substr($data["ccity"],0,100);
		$showRawValues["cstate"] = substr($data["cstate"],0,100);
		$showRawValues["ccountry"] = substr($data["ccountry"],0,100);
		$showRawValues["ctel"] = substr($data["ctel"],0,100);
		$showRawValues["cfax"] = substr($data["cfax"],0,100);
		$showRawValues["cemail"] = substr($data["cemail"],0,100);
