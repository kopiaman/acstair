...
class CrossTableReport
{
	...
	public function isProjectDB()
	{
		...
		if("user" == $this->xml_array['tables'][0])
			$isDB = true;
		if("paper" == $this->xml_array['tables'][0])
			$isDB = true;
		if("conference" == $this->xml_array['tables'][0])
			$isDB = true;
		if("set_field" == $this->xml_array['tables'][0])
			$isDB = true;
		if("set_cat" == $this->xml_array['tables'][0])
			$isDB = true;
		if("conslider" == $this->xml_array['tables'][0])
			$isDB = true;
		if("congallery" == $this->xml_array['tables'][0])
			$isDB = true;
		if("congallery" == $this->xml_array['tables'][0])
			$isDB = true;
		if("conpartner" == $this->xml_array['tables'][0])
			$isDB = true;
		if("quote" == $this->xml_array['tables'][0])
			$isDB = true;
		if("company" == $this->xml_array['tables'][0])
			$isDB = true;
		if("participate" == $this->xml_array['tables'][0])
			$isDB = true;
		if("set_fee" == $this->xml_array['tables'][0])
			$isDB = true;
		if("confees" == $this->xml_array['tables'][0])
			$isDB = true;
		if("payments" == $this->xml_array['tables'][0])
			$isDB = true;
		if("participate" == $this->xml_array['tables'][0])
			$isDB = true;
		if("participate" == $this->xml_array['tables'][0])
		...
		if("paper" == $this->xml_array['tables'][0])
			$isDB = true;
		if("webslider" == $this->xml_array['tables'][0])
			$isDB = true;
		if("payments" == $this->xml_array['tables'][0])
			$isDB = true;
		if("paper" == $this->xml_array['tables'][0])
		...
		if("paper" == $this->xml_array['tables'][0])
			$isDB = true;
		if("followup" == $this->xml_array['tables'][0])
			$isDB = true;
		if("participate" == $this->xml_array['tables'][0])
			$isDB = true;
		if("user" == $this->xml_array['tables'][0])
