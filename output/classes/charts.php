...
class Chart
{
	...
	protected function isProjectDB()
	{
		...
		if("user" == $this->chrt_array['tables'][0])
			return true;
		if("paper" == $this->chrt_array['tables'][0])
			return true;
		if("conference" == $this->chrt_array['tables'][0])
			return true;
		if("set_field" == $this->chrt_array['tables'][0])
			return true;
		if("set_cat" == $this->chrt_array['tables'][0])
			return true;
		if("conslider" == $this->chrt_array['tables'][0])
			return true;
		if("congallery" == $this->chrt_array['tables'][0])
			return true;
		if("congallery" == $this->chrt_array['tables'][0])
			return true;
		if("conpartner" == $this->chrt_array['tables'][0])
			return true;
		if("quote" == $this->chrt_array['tables'][0])
			return true;
		if("company" == $this->chrt_array['tables'][0])
			return true;
		if("participate" == $this->chrt_array['tables'][0])
			return true;
		if("set_fee" == $this->chrt_array['tables'][0])
			return true;
		if("confees" == $this->chrt_array['tables'][0])
			return true;
		if("payments" == $this->chrt_array['tables'][0])
			return true;
		if("participate" == $this->chrt_array['tables'][0])
			return true;
		if("participate" == $this->chrt_array['tables'][0])
		...
		if("paper" == $this->chrt_array['tables'][0])
			return true;
		if("webslider" == $this->chrt_array['tables'][0])
			return true;
		if("payments" == $this->chrt_array['tables'][0])
			return true;
		if("paper" == $this->chrt_array['tables'][0])
		...
		if("paper" == $this->chrt_array['tables'][0])
			return true;
		if("followup" == $this->chrt_array['tables'][0])
			return true;
		if("participate" == $this->chrt_array['tables'][0])
			return true;
		if("user" == $this->chrt_array['tables'][0])
