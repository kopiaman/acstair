...
$layout = new TLayout("register","Rounded1White_label1","MobileWhite_label1");
...
$layout = new TLayout("register_success","Rounded1White_label1","MobileWhite_label1");
$layout->blocks["top"] = array();
$layout->containers["fields"] = array();
...
//	processibng password - end
	...
	if($cipherer->isFieldEncrypted("email"))
		$sUsername = $cipherer->MakeDBValue("email",$strUsername,"","",true);	
	else 
		$sUsername = add_db_quotes("email",$strUsername);
	
	if($cipherer->isFieldEncrypted(""))
		$sEmail = $cipherer->MakeDBValue("",$strEmail,"","",true);	
	else 
