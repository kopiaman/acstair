...
$layout->blocks["top"][] = "pdf";$page_layouts["website_print"] = $layout;
...
//	wid - 
			$record["wid_value"] = $pageObject->showDBValue("wid", $data, $keylink);
			$record["wid_class"] = $pageObject->fieldClass("wid");
//	cid - 
			$record["cid_value"] = $pageObject->showDBValue("cid", $data, $keylink);
			$record["cid_class"] = $pageObject->fieldClass("cid");
//	slider - 
			$record["slider_value"] = $pageObject->showDBValue("slider", $data, $keylink);
			$record["slider_class"] = $pageObject->fieldClass("slider");
			if($col<$colsonpage)
...
$xt->assign("wid_fieldheadercolumn",true);
$xt->assign("wid_fieldheader",true);
$xt->assign("wid_fieldcolumn",true);
$xt->assign("wid_fieldfootercolumn",true);
...
$xt->assign("slider_fieldheadercolumn",true);
$xt->assign("slider_fieldheader",true);
$xt->assign("slider_fieldcolumn",true);
$xt->assign("slider_fieldfootercolumn",true);
