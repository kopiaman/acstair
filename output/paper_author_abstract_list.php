...
$layout = new TLayout("list62","Rounded1Orange1","MobileOrange1");
...
$layout->blocks["center"][] = "pagination";$layout->blocks["top"] = array();
...
$layout->blocks["top"][] = "recordcontrols";$page_layouts["paper_author_abstract_list"] = $layout;
...
{	
	...
	//determine which field should be used to select values
			$params["lookupSelectField"] = "fullPaper";
				}
