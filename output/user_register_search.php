...
$layout = new TLayout("search2","Rounded1White_label1","MobileWhite_label1");
...
$layout->blocks["top"][] = "search";$page_layouts["user_register_search"] = $layout;
...
$mode = SEARCH_SIMPLE;
$templatefile = "user_register_search.htm";
...
$params['shortTableName'] = 'user_register';
...
if ($mode==SEARCH_SIMPLE)
{
	...
	if($pageObject->pSet->getLookupTable("role"))
		$pageObject->settingsMap["globalSettings"]['shortTNames'][$pageObject->pSet->getLookupTable("role")] = GetTableURL($pageObject->pSet->getLookupTable("role"));
	...
	if(isEnableSection508())
		$xt->assign_section("role_label","<label for=\"".GetInputElementId("role", $id, PAGE_SEARCH)."\">","</label>");
	else 
